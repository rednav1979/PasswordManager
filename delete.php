...
<span id='topo'></span>
   ...
   $sqltudo = mysql_query("select  * FROM control_passwords  where  id=('$colaborador_retorno')")  or die(mysql_error());
...
// INCLUI O NUMERO DE HISTORICOS AO LADO DO ICONE DE HISTORICO
   include "sql_t.i.php";//conexão com o banco de dados   
   @mysql_select_db($db);//selecione o banco de dados
   $sqltudo2 = mysql_query("SELECT * FROM control_passwords_historico where id_historico = $id ")  or die(mysql_error());
